...
export class JudgerController {
    ...
    async getAllTrans(): Promise<{ [key: string]: unknown }> {
        return this.mapToPlainObject(await this.transService.getTransMap());
    }
    ...
    async getWsTrans(): Promise<{ [key: string]: unknown }> {
        ...
        for (const [key, val] of (
            await this.transService.getWsAllTrans()
        ).entries()) {
    ...
    async getHeartBeat(): Promise<{ [key: string]: unknown }> {
        return this.mapToPlainObject(await this.wsService.getLifeMap());
    }

    @Get("alltoken")
    async getAllToken(): Promise<{ [key: string]: unknown }> {
        return this.mapToPlainObject(await this.wsService.getTokenMap());
    }

    @Get("report")
    async getReport(): Promise<{ [key: string]: unknown }> {
        return this.mapToPlainObject(await this.wsService.getReportMap());
    }
